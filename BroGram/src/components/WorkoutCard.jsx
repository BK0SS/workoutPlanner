                ...
                {warmup.map((warmupExercise, warmupIndex) =>{
                    return(
                        <React.Fragment key={warmupIndex}>
                            ...
                            <p className="exercise-info">Sets: {warmupExercise.sets}</p>
                            <p className="exercise-info">Reps: {warmupExercise.reps}</p>
                ...
                {workout.map((workoutExercise, wIndex) =>{
                    return(
                        <React.Fragment key={wIndex}>
                            ...
                            <p className="exercise-info">Sets: {workoutExercise.sets}</p>
                            <p className="exercise-info">Reps: {workoutExercise.reps}</p>
                            <input className="weight-input" value={weights[workoutExercise.name] || ""} onChange={(e)=>{
